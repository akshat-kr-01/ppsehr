...
# Note: Remember to hide this key when uploading to GitHub!
...
# ADDED: This prevents the app from crashing on hot-reloads!
if 'active_epsilon' not in st.session_state:
    st.session_state.active_epsilon = None
...
if uploaded_file is None:
    ...
    if st.session_state.raw_ai_data is not None and st.session_state.active_epsilon is not None:
